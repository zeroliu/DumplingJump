...
//            DLog(@"%@", [((CCAnimation *) animation).frames description]);
    ...
    } else 
    {
        ...
        AddthingObject *newObject;
        newObject = [[[AddthingObject alloc] initWithID:ID name: @"wrongObject" file:[NSString stringWithFormat: @"%@.png", @"A_wrongObject"] body:objectBody canResize:YES reaction:nil animation:nil wait:0 warningTime:0 firstTouchSFX:nil] autorelease];
